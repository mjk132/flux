...
function FilterSection({
  ...
  return (
    <div className="border-t border-border/60 pt-4 first:border-0 first:pt-0 first:mt-0 mt-4">
      <h3 className="mb-2.5 text-[11px] font-bold uppercase tracking-[0.16em] text-gray-muted">
        {title}
      </h3>
      {children}
    </div>
...
function StoreContent() {
  ...
  const pageSubtitle = activeCategory
    ...
    : "بوتات، سكربتات، مواقع وخدمات رقمية — تسليم فوري بعد الدفع.";
  ...
  const filterPanel = (
    <div className="rounded-2xl border border-border bg-surface/70 p-4 backdrop-blur-sm">
      <div className="mb-4 flex items-center justify-between">
        <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-purple-accent">
          الفلاتر
        </span>
        {hasFilters && (
          <button
