...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#e9f0ff] via-[#ffffff] to-[#ffffff]" />
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 py-16 md:py-24 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="max-w-xl">
            {/* Eyebrow */}
            <div className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-blue-100 bg-[#ffffff]/80 px-3.5 py-1.5 shadow-sm backdrop-blur-sm">
            ...
            {/* Headline */}
            <h1 className="text-balance text-4xl font-extrabold leading-[1.15] tracking-tight text-white sm:text-5xl lg:text-[54px]">
              حلول رقمية،
              <span className="mt-1 block text-gradient">بهوية مختلفة</span>
            </h1>

            {/* Sub */}
            <p className="mt-5 max-w-md text-[15px] leading-relaxed text-gray-text sm:text-base">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                href="/store"
                className="group inline-flex h-12 items-center gap-2 rounded-xl bg-purple-accent px-7 text-[14px] font-bold text-[#ffffff] transition-all hover:bg-[#1e6bff] hover:shadow-[0_0_30px_rgba(47,123,255,0.4)]"
              >
                تصفح المتجر
              ...
              <Link
                href="/faq"
                className="inline-flex h-12 items-center gap-2 rounded-xl border border-border bg-[#ffffff]/60 px-6 text-[14px] font-semibold text-gray-text transition-all hover:border-purple-accent/50 hover:text-white"
              >
                كيف يعمل؟
              </Link>
            </div>
            ...
            {/* Trust row */}
            <div className="mt-10 flex flex-wrap gap-x-7 gap-y-3 border-t border-border pt-6">
              {trust.map((t) => (
                <span
                  key={t.label}
          ...
          <div className="relative mx-auto w-full max-w-md lg:max-w-none">
            ...
            <div className="animate-float absolute right-0 top-8 z-10 hidden sm:block">
              <div className="flex items-center gap-2.5 rounded-2xl border border-blue-100 bg-[#ffffff]/90 px-4 py-3 shadow-xl shadow-blue-500/10 backdrop-blur-md">
            ...
            <div className="animate-float-slow absolute -right-1 top-1/3 z-10 hidden md:block">
              <div className="flex items-center gap-2 rounded-full border border-success/25 bg-[#ffffff]/95 px-3 py-1.5 shadow-lg shadow-success/10 backdrop-blur-md">
            ...
            <div className="animate-float-slow absolute bottom-0 right-8 z-10 hidden lg:block">
              <div className="flex items-center gap-2 rounded-2xl border border-blue-100 bg-[#ffffff]/95 px-3.5 py-2.5 shadow-xl shadow-blue-500/10 backdrop-blur-md">
            ...
            <div className="relative z-[5] mx-auto w-[88%] sm:w-[80%]">
              <div className="rounded-[28px] bg-[#ffffff] p-2 shadow-[0_30px_80px_-20px_rgba(47,123,255,0.45)] ring-1 ring-blue-100">
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#ffffff] to-transparent" />
          </div>
        </div>
      </div>
