...
CREATE TABLE "Inventory" (
    ...
    CONSTRAINT "Inventory_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "Inventory_orderId_idx" ON "Inventory"("orderId");
